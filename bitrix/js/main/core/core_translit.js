...
BX.CYandexTranslator.prototype.translate = function()
{
	...
	var cb_name = 'yandex_translate_callback_' + parseInt(Math.random() * 100000),
		url = 'https://translate.yandex.net/api/v1.5/tr.json/translate?key='+BX.message('YANDEX_KEY')+'&lang='+BX.message('LANGUAGE_ID')+'-en&callback=' + cb_name + '&clientId=bitrix' + text;
