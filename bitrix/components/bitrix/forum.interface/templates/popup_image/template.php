...
else
{
	...
	ob_start();
	?><script>if(!!addForumImagesShow){addForumImagesShow('<?=$id?>');}else{BX.loadScript(['<?=CUtil::GetAdditionalFileURL('/bitrix/js/forum/popup_image.js')?>'], function(){addForumImagesShow('<?=$id?>');});}</script><?
